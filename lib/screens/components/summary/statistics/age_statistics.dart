...
class AgeSummary extends StatefulWidget {
  const AgeSummary({super.key, required this.titulo});

  /// Title of the widget.
  final String titulo;

  @override
  State<AgeSummary> createState() => _AgeSummaryState();
}

/// State of the widget [Summary].
class _AgeSummaryState extends State<AgeSummary> {
  late Future<Map<String, int?>> _statsFuture;

  @override
  void initState() {
    super.initState();
    _statsFuture = statsController.ageStatistics(userId);
  }
